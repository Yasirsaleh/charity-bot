...
1. إنشاء حساب (رقم جوال/بريد) وتعبئة البيانات الأساسية.
1. اختيار نوع الخدمة: تدريب / إرشاد / احتضان / تحول رقمي / تطوع.
1. رفع المستندات المطلوبة.
1. اختيار موعد أو برنامج مناسب.
1. استلام رسالة تأكيد الطلب.
1. يتم دراسة الطلب ثم: قبول مباشر، أو إدراج في قائمة انتظار، أو طلب معلومات إضافية.
...
const twiml = `<?xml version="1.0" encoding="UTF-8"?> <Response> <Message>عذراً، حدث خطأ تقني. يرجى المحاولة لاحقاً أو التواصل مع جمعية ياسر للتقنية مباشرة.</Message> </Response>`;
